...
<div id="log-in" class="site-form log-in-form">
    ...
    <div id="log-in-head">
        <h1>Log in</h1>
        <div id="logo">
            <a href="{{ url('/') }}"><img src="img/logo.png" alt=""></a></div>
    </div>
    ...
    <div class="form-output">
        <form action="{{ route('login') }}" method="post">
            ...
            <a href="{{ url('login/facebook') }}" class="btn btn-lg bg-facebook full-width btn-icon-left"><i class="fa fa-facebook" aria-hidden="true"></i>Login with Facebook</a>

            <p><br>Don't you have an account? <a href="{{ url('register') }}">Register Now!</a> </p>
        </form>
    </div>
</div>
<!--======= // log_in_page =======-->
